...
backgroundImage.src = "images/background.png"; //FIND BACKGROUND PICTURE

var speedMod = .5;
var gameOn = false;

var hero = new Image();
hero.src = "images/boat.png"; //FIND HERO PICTURE
var heroLoc = {
	x: 800,
	y: 205
};
...
monster.src = "images/fish-left.gif"; //FIND MONSTER PICTURE
var monsterLoc = {
	x: 200,
	y: 400
}
...
var enemy = new Image();
enemy.src = "images/pirate-ship.png";
var enemyLoc = {
	x: 200,
	y: 205
}
...
cannonLeft.src = "images/cannon-ball.png";
var cannonLeftLoc = {
	x: 800,
	y: 225
}
var cannonRight = new Image();
cannonRight.src = "images/cannon-ball.png";
var cannonRightLoc = {
	x: 810,
	y: 225
}
...
function update(){
	...
	// }
			...
			enemy.src = "images/explosion.png"
				if(enemy.src = "images/explosion.png"){
					enemy.src = "images/boat.png";
					enemyLoc.x = 0;
					if(enemy.src = "images/boat.png"){
						enemy.src = "images/pirate-ship.png";
					}
				}
